...
function applyThemePreference(isDark) {
  if (isDark) {
    ...
    themeSwitch.setAttribute("data-tooltip", "Switch to Light Mode");
  } else {
    document.body.classList.remove("dark-mode");
    themeSwitch.innerHTML = '<i class="fas fa-moon"></i>';
    themeSwitch.setAttribute("data-tooltip", "Switch to Dark Mode");
  }
}
...
function initProjectGallery() {
  ...
  const projectImages = {
    society: [
      {
        src: "images/img-society/landing page.jpg",
        alt: "society management system",
      },
      {
        src: "images/img-society/landing page 2.jpg",
        alt: "sms-2",
      },
      { src: "images/img-society/all events.jpg", alt: "events all" },
      { src: "images/img-society/eventpage.jpg", alt: "event" },
      { src: "images/img-society/reg form.jpg", alt: "reg form society " },
      { src: "images/img-society/no more slots.jpg", alt: "slots society " },
      {
        src: "images/img-society/societyhead-event screen.jpg",
        alt: "scoeity head scnreen events ",
      },
      { src: "images/img-society/reg form.jpg", alt: "reg form society " },
    ],
    doctor: [
      ...
      { src: "images/doctorr.jpg", alt: "Doctor Interface" },
      { src: "images/doctor.png", alt: "Doctor Dashboard" },
      { src: "images/admin.png", alt: "Admin Dashboard" },
    ],
    dm: [
      {
      ...
      { src: "images/client.jpg", alt: "Doctor Interface" },
      { src: "images/client2.jpg", alt: "Doctor Dashboard" },
      { src: "images/admin-dash.jpg", alt: "Admin Dashboard" },
      { src: "images/projects.jpg", alt: "project Dashboard" },
      { src: "images/project2.jpg", alt: "project Dashboard" },
    ],
    noteapp: [
      { src: "images/notepad.jpg", alt: "NoteApp Interface" },
      { src: "images/notepad sample.png", alt: "NoteApp Sample" },
      { src: "images/notepad smaple2.png", alt: "NoteApp Features" },
      { src: "images/noteapp.jpg", alt: "NoteApp Interface" },
    ],
    todo: [
      { src: "images/todo home.png", alt: "TO-DO List App Home" },
      { src: "images/todo sample2.png", alt: "TO-DO List Interface" },
    ],
    ui: [
    ...
    aws: [
      { src: "images/aws/img.jpg", alt: "AWS Management Chatbot" },
      { src: "images/aws/img2.jpg", alt: "AWS Chatbot Features" },
      { src: "images/aws/img3.jpg", alt: "AWS Chatbot Interface" },
    ],
  };

  // Project titles mapping
  const projectTitles = {
    society: "Society Management System",
